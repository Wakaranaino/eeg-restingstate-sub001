...
subject_list = {'sub-001', 'sub-002', 'sub-003'};  % Add more subject IDs here
...
for s = 1:length(subject_list)
    ...
    output_prefix = [subject_id '_v2.0'];
...
if load_cleaned_set
    ...
    % Save final dataset
    EEG = pop_saveset(EEG, 'filename', [output_prefix '_cleaned_final.set'], 'filepath', subject_output_dir);
end
